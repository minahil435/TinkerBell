        ...
        AR.orderByKey().addListenerForSingleValueEvent(new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot snapshot)
            {
                if (snapshot.hasChild(scanContent))
                {
                    ...
                    AR.child(scanContent).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot)
                        {
                            ...
                            {progressDialog.dismiss();
                                ...
                                Intent intend = new Intent(BarcodeScannerActivity.this, FaceTrackerActivity.class);
                                ...
                                Toast.makeText(BarcodeScannerActivity.this, "Your location don't match ", Toast.LENGTH_SHORT).show();
                                Intent intend = new Intent(BarcodeScannerActivity.this, Profile.class);
                                startActivity(intend);
                                finish();
                            }
                    ...
                    {
                    progressDialog.dismiss();
                    Toast.makeText(BarcodeScannerActivity.this, "This QR code dont belongs to any Tinkerbell user", Toast.LENGTH_SHORT).show();
                    Intent intend = new Intent(BarcodeScannerActivity.this, Profile.class);
                    startActivity(intend);
                    finish();
                }
