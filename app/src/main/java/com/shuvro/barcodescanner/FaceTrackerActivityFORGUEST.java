 ...
 */
public final class FaceTrackerActivityFORGUEST extends AppCompatActivity
{
    ...
    CameraSource.PictureCallback jpegCallback = new CameraSource.PictureCallback() {
        ...
        public void onPictureTaken(byte[] bytes) {
            ...
            progressDialog = new SpotsDialog(FaceTrackerActivityFORGUEST.this, R.style.Custom5);
            progressDialog.show();
            ...
            AR.addValueEventListener(new ValueEventListener()
            {
                ...
                public void onDataChange(DataSnapshot dataSnapshot)
                {
                    if (dataSnapshot.hasChild(visitorID))
                    {
                        ...
                        {
                        Toast.makeText(FaceTrackerActivityFORGUEST.this, "User is not registered to any device", Toast.LENGTH_SHORT).show();
                        Intent intend = new Intent(FaceTrackerActivityFORGUEST.this, UserAddition.class);
    ...
    public void sendPushNotification(String token) throws IOException, JSONException
    {
        ...
        if(responseCode==200)
        {
            Intent intend = new Intent(FaceTrackerActivityFORGUEST.this, Confirmation.class);
            startActivity(intend);
            finish();
        ...
        {
            Intent intend = new Intent(FaceTrackerActivityFORGUEST.this, BarcodescannerFORGUEST.class);
            startActivity(intend);
            finish();
